Function Get-PSRuntimeEnviromentModule
{
<#
	.SYNOPSIS
...
Get-PSRuntimeEnviromentModule @Params
#>
	[CmdletBinding()]
	Param
	(
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1viI9fsGzUrVD
# 95ngzx1TCk9HaZfncF9u4FwOvHKf7aCCJnowggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgN2hpaEnoZ7+ZPwsC9GPA
# qK0uT9dOK88H+xVOm5J1nagwDQYJKoZIhvcNAQEBBQAEggIAdTxE7oGg/MSD2XFu
# ZKnTh0ctEuK2IXL77YVbJdo60wvaknzhSf1Y+E++iD58S8eFFbx1hMnnuHbPoxaU
# sLV/kXIvhG8qcBRfNYp6DeU5c2GhF9tdLSxUEW37Tzv6Dq3piud76VX06qVlDbEs
# Pot+lNHWnh8fyGiDJYPsDNHnf4zoEEvHRgNQbkQXkwLakSeLvAsFwU+6bjTAGWI1
# REs/9jtYa8s/SO/YlWhkr/AASg+UeebK6ziJpXeDRrayMLtvsjEdiWPdfO3Kh2wJ
# rA1kaAgVW6xyi3vqGBkfOI6vgnqQxqBF92UlsC2EuL5OyTOgkWPSDInD7rjM3S6V
# 3yZGmc45/S4wzvll2mmuSY+vtIqqFsKiAhT7CX7T6QIxvriiuvOg3j5QfUWwZKNZ
# Aej0QxbzB66er/yRrEA/RbwFC+TgVO6W4w/BgbB+cCc/m/9GQ+ndQLd1RsFMz1Sr
# U2BUs1I774kp1m/C3Uro+tM5NRsAU4IN27Bhl4ze+lc9nBgGRDDxy4e4g7p2GR+B
# i+ECxlXSu1Lj6tHPHLdpB/M8ICl1MRbOL3QJrpAzMqhrAui1EaosUiryYcql6n80
# cee9uToFU1kacxvjocF4pd8kSdsxPR5zAcPG3p/TSkNLktEVzzMW8Kf7ZKIv9Jzo
# AlPLTKhMjdohtQ0TR04yYo87ApShggQCMIID/gYJKoZIhvcNAQkGMYID7zCCA+sC
...
# BgsqhkiG9w0BCRABBDAcBgkqhkiG9w0BCQUxDxcNMjQwNzE4MTM0NTAzWjA3Bgsq
# hkiG9w0BCRACLzEoMCYwJDAiBCDqlUux0EC0MUBI2GWfj2FdiHQszOBnkuBWAk1L
# ADrTHDA/BgkqhkiG9w0BCQQxMgQw8SoPfAAv+R+BUyBnwzvMLPGzqnikMaR/bW9S
# ij10G1Np/zDQYzOl+9rq0POONl8LMIGfBgsqhkiG9w0BCRACDDGBjzCBjDCBiTCB
...
# DQEBAQUABIICAI6EGTReH9GN4f/qSYVL8Dg6fnCf/olYb2f/sttSceneGR4mupjN
# sWAKyoW9Ty1QL/MxMjbOSN7KnwoJ2v6zF/JKYFuiX9YSh9Hcfkg4GpFW35Ic0dIB
# Z+N7XKgEEaQbBGQj6IG3wDKzPoxcRDbgOjTaf7vQcCIlB6JjF6xdLwnTQC9nhWRV
# 5Mg28fSnxLpDE3jV2CFPaabN3aV1dHGJ2nMFcyMlvi/zRsp5wqsaGWAYfPvqeX+B
# dsX/BO/Bo9XflyZzIRgh26w5x8wWdS1G9lmKHIMmRs6vS7TTRvp1Ei22ciR3F/IH
# rm+ACTsp8YyfmtPJ2AJ3yY4RqsKUKsT8pHL6Y9vV9nkWbnJDT+Od+5Y+CWnGlwgA
# +YgPIShDpxH+zDiob/L05Q6avx8CbXoOvBVy0scIiKFN11mSv0bz8ofCyLj+s0ch
# I50gUHE9lKJ7Ds8KE/joo3j8+MGGupu+TBVomj34OwfnaS7toIBb6OBClItbVzxy
# jxg0t7tx95QxgqjX3KGdW4uLrytgtJjm0EuGagvSXQ7/+vQCQpyGYwvDPhbh0ow7
# xzHCkNlVXmRQjWy+pBGhWK1Bid/3GGV99KcUZkJDDlJVvML9xq006TewaKCuPSy8
# afsyn577MeGlmtjRDGsuM/7WNB7HvHWSfNxE6Ta/aUNIkOGw0j1WoDM0
